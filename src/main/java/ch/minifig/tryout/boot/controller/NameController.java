...
import ch.minifig.tryout.boot.model.Client;
import ch.minifig.tryout.boot.model.ClientRepository;
import ch.minifig.tryout.boot.util.BadRequestException;
import ch.minifig.tryout.boot.util.ResourceNotFoundException;
